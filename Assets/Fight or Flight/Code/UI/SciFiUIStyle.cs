...
{
    public static readonly Color Teal      = new Color(0f,     1f,     0.831f, 1f);
    public static readonly Color DarkBg    = new Color(0.039f, 0.055f, 0.102f, 1f);
    public static readonly Color GreenGlow = new Color(0.224f, 1f,     0.078f, 1f);
